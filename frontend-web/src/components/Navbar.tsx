	...
	return (
        ...
        drop-shadow-md"
			>
				...
				<div>
					<ul className="hidden sm:flex items-center text-yellow-600 gap-8">
				...
				<div
					onClick={handleClick}
					className="flex sm:hidden text-3xl text-yellow-600 bg-primary-300 hover:bg-primary-200 dark:bg-primary-700 dark:hover:bg-primary-600 rounded-md p-1 cursor-pointer drop-shadow-md"
				>
					<BiMenu />
				</div>
			</div>
			<div
				...
				} w-screen absolute z-10 top-0 bg-primary-800 sm:hidden py-8 px-14`}
			>
				<div
					onClick={() => handleClick()}
					className="text-3xl text-yellow-600 bg-primary-700 hover:bg-primary-800 cursor-pointer rounded-md p-1 w-10 h-10 drop-shadow-md flex justify-center items-centers"
				>
					<AiOutlineClose />
				</div>
				<ul className="text-base flex flex-col items-center gap-4 text-yellow-600 py-6">
					<Navlink icon={<BiHome />} name="Home" />
					<Navlink icon={<BsPerson />} name="Personal" />
					<Navlink icon={<BsTelephone />} name="Contact" />
				</ul>
